            ...
            <div className="flex gap-2 sm:gap-3">
              <Link href="/calendar">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full w-10 h-10 sm:w-12 sm:h-12 bg-white/40 dark:bg-black/20 hover:bg-white/50 backdrop-blur-md shadow-sm border border-[var(--glass-border)] transition-all hover:scale-110 active:scale-95"
                >
