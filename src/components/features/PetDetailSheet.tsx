                ...
                <div className="h-full px-4 py-4">
                    <Tabs defaultValue="general" className="h-full flex flex-col">
                        <TabsList className="glass-capsule w-full p-1 rounded-full mb-6 shadow-sm bg-muted/20">
                            ...
                            <TabsTrigger value="task" className="flex-1 rounded-full text-xs font-bold data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all h-9">
                                <ListTodo className="w-3.5 h-3.5 mr-1.5" />タスク
                            </TabsTrigger>
                            <TabsTrigger value="member" className="flex-1 rounded-full text-xs font-bold data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all h-9">
                                <Users className="w-3.5 h-3.5 mr-1.5" />共有
                            </TabsTrigger>
                            <TabsTrigger value="danger" className="flex-1 rounded-full text-xs font-bold data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-red-500 transition-all h-9">
                                <Shield className="w-3.5 h-3.5 mr-1.5" />高度
                            </TabsTrigger>
                        </TabsList>

                        <div className="flex-1 overflow-y-auto pb-20 space-y-6 scrollbar-hide">
                            <TabsContent value="general" className="mt-0 space-y-6 focus-visible:ring-0 outline-none">
                                {/* Hero Section */}
                            ...
                            <TabsContent value="task" className="mt-0 focus-visible:ring-0 outline-none">
                            ...
                            <TabsContent value="member" className="mt-0 focus-visible:ring-0 outline-none">
                                <div className="glass rounded-[2rem] p-5 border-white/20">
                                    <div className="flex items-center gap-2 mb-3 text-muted-foreground">
                            ...
                            <Dialog open={!!selectedMember} onOpenChange={(open) => !open && setSelectedMember(null)}>
                                <DialogContent className="glass border-white/20 rounded-[2rem] p-0 overflow-hidden max-w-sm mx-auto w-[90%] sm:w-full">
                                    ...
                                    <div className="pt-12 pb-6 px-6 text-center space-y-4">
                                        ...
                                        <div className="bg-white/10 p-4 rounded-2xl border border-white/10 text-left space-y-3">
                                            <div className="flex items-center justify-between">
                                                <span className="text-muted-foreground text-xs font-bold uppercase tracking-wider">権限</span>
                                            ...
                                            <div>
                                                <span className="text-muted-foreground text-xs font-bold uppercase tracking-wider block mb-1">説明</span>
                                                <p className="text-xs text-muted-foreground/80 leading-relaxed">
                                                    {MEMBER_ROLES.find(r => r.value === selectedMember?.role)?.description}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <TabsContent value="danger" className="mt-0 focus-visible:ring-0 outline-none">
                                <div className="glass rounded-[2rem] p-6 border-red-500/20 bg-red-500/5 space-y-4">
                                    ...
                                    {(!isOwner || canOwnerLeave) ? (
                                        <>
                                            <p className="text-sm text-muted-foreground">チームから脱退すると、再度招待されるまでこのペットの情報にはアクセスできなくなります。</p>
                                            <AlertDialog>
                                                <AlertDialogTrigger asChild>
